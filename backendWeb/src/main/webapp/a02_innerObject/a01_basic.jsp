...
<style type = "text/css">
	...
	td{text-align: center; background-color:;}
</style>
...
3. 출력 메서드
	...
	2) out.println() : 데이터를 출력하고 줄바꿈 처리까지 한다
 ...
 <%--
 		ex) 1~25까지 5x5 테이블을 out 이용하여 출력하되, 해당 cell을 클릭시, 배경색상이 변경되게 하세요
 	1. 기본 tag로 기본틀을 만든다
 	2. 반복적으로 처리할 내용 확인
 		==> 반복문 처리
 		- 1) tag별로 분리시켜 out.print()
 		- 2) 변경될 부분 확인
 	3. 반복step이 규칙적으로 다른 내용
 		==) if 조건문을 통해서 처리	
 --%>
	<h2>5x5 테이블</h2>
