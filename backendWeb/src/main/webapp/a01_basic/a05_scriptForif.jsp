...
--%>
	...
	%>
	<%--
	ex) 반복문을 활용하여 임의의 구구단을 설정하고, 테이블을 통해서 출력하세요
	@@ 단
	@ X 1 = @
	@ X 2 = @
	@ X 3 = @
	...
	ex3) form 화면에서
		 ...
		 점수부분을 <input 형식을 values값에 점수가 입력되어 출력되게하고
		 반복문을 통해서 학생 5명을 출력하되 점수는 임의로 0~100 사이에 나오게 하세요
	--%>
	<form>
