...
<head>
    ...
    <%--
    # 요청값을 전달해서 서버단 데이터를 처리 후, front 프로그램에 넘겨서, front에 나타나는 내용을 처리
    1. id/pass 입력 ==> 서버단에서 인증 확인(java) ==> 인증되면 로그인 성공 / 특정 main이동 (프런트단 전달)
    미인증시 로그인 실패/ 로그인 다시 처리
     --%>
</head>
<%
...
<script type = "text/javascript">
	...
	// id :	[  ][등록된 회원여부 check]
	// jsp : 요청값으로 himan
	// js : 등록 여부에 따라 등록된 회원 있습니다 그외는 등록 가능합니다
</script>
<body>
