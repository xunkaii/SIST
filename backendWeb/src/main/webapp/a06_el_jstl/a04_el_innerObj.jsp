...
<body>
	<div class="container mt-3">
		...
		<form action="" method="post">
			<div class="mb-3 mt-3">
				<label for="sname">학생명:</label> <input type="text"
					class="form-control" id="sname" name="sname">
			</div>

			<div class="mb-3 mt-3">
				<label>국어점수:</label> <input type="number" class="form-control"
					name="point">
			</div>
			<div class="mb-3 mt-3">
				<label>영어점수:</label> <input type="number" class="form-control"
					name="point">
			</div>
			<div class="mb-3 mt-3">
				<label>수학점수:</label> <input type="number" class="form-control"
					name="point">
			</div>
