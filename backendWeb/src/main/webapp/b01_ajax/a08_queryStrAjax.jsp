...
<script type="text/javascript">
	...
	function ajaxCall() {
		...
		var page = "z08_reqJson.jsp?player=" + player + "&seat=" + seat
				+ "&hit=" + hit
...
<body>
	<div class="container mt-3">
		...
		<form action="" method="post">
			<div class="mb-3 mt-3">
				<label for="ename">선수명:</label> <input type="text"
					class="form-control" id="player" placeholder="선수명 입력" name="ename">
			</div>
			<div class="mb-3 mt-3">
				<label for="empno">타석:</label> <input type="number"
					class="form-control" id="seat" placeholder="타석 입력" name="empno">
			</div>
			<div class="mb-3 mt-3">
				<label for="empno">안타:</label> <input type="number"
					class="form-control" id="hit" placeholder="안타 입력" name="empno">
			</div>
