...
1. 화면처리
	...
	5) 수정 프로세스 ajax로 처리 	
		주의) 기존 등록 process와 구분할 수 있도록 input hidden으로 process 처리
...
<script type="text/javascript">
	...
	function detail(no) {
		...
		document.querySelector("#modal-title").innerText = "코드상세화면[코드번호:"+no+"]"
...
<body>
	<div class="container mt-3">
		...
		<div id = "detailModal" data-bs-togle="modal" data-bs-target = "#myModal"></div>
		<button type="button" onclick = "insModal()" class="btn btn-success" data-bs-toggle="modal"
