...
<script type="text/javascript">
	...
	function callBuy() {
		...
		var page = "z07_reqJson.jsp?name=" + nameVal + "&price=" + priceVal
				+ "&cnt=" + cntVal
...
<body>
	<div class="container mt-3">
		...
		<form action="" method="post">
			<div class="mb-3 mt-3">
				<label for="name">물건명:</label> <input type="text"
					class="form-control" id="name" placeholder="물건명 입력" name="name">
			</div>
			<div class="mb-3 mt-3">
			...
			<div class="mb-3 mt-3">
				<label for="cnt">갯수:</label> <input type="number"
					class="form-control" id="cnt" placeholder="갯수 입력" name="cnt">
			</div>
